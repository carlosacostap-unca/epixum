...
import { getCourse, getCourseTeachers } from '@/app/actions/courses'
import { redirect } from 'next/navigation'
import CourseTeacherManagement from '@/components/CourseTeacherManagement'

export default async function CourseTeachersPage(props: { params: Promise<{ id: string, courseId: string }> }) {
            ...
            <div className="w-full max-w-6xl">
                <div className="mb-8 flex flex-col gap-2">
                    <div className="flex justify-between items-center">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-100">Gestión de Docentes</h1>
